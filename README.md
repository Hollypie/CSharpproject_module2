...
The software simulates foundational game systems such as player statistics and leveling, enemy AI decision-making, turn-based interactions, and optional save/load functionality. These systems are designed to be modular, extensible, and directly transferable to future Unity projects.
